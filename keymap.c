...
const qk_tap_dance_action_t tap_dance_actions[] = {
	// once for backspace, twice for escape
	[TBES] = ACTION_TAP_DANCE_DOUBLE(KC_TAB, KC_ESC),
};
 ...
 */
[_QWERTY] = {
  {TD(TBES),KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC},
...
[_LOWER] = {
  ...
  {KC_PIPE, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_ENT },
...
[_RAISE] = {
  ...
  {KC_BSLS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_ENT },
